...
import { IGetCompletedMeetingsUseCase } from "../../interface/meeting/IGetCompletedMeetingUseCase";

export class GetCompletedMeetingsUseCase implements IGetCompletedMeetingsUseCase {
    constructor(
    ...
    async execute(
        ...
        const items = await this._meetingRepo.findCompletedMeetings(data.projectId);
