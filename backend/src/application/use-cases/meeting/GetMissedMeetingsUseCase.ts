...
import { IGetMissedMeetingsUseCase } from "../../interface/meeting/IGetMissedMeetingsUseCase";

export class GetMissedMeetingsUseCase implements IGetMissedMeetingsUseCase {
    constructor(
    ...
    async execute(
        ...
        const items = await this._meetingRepo.findMissedMeetings(data.projectId);
