...
import { IUpdateWorklogUseCase } from "../../interface/worklog/IUpdateWorklogUseCase";
...
export class UpdateWorklogUseCase implements IUpdateWorklogUseCase {
  ...
  async execute(
    ...
    projectId: string,
    worklogId: string,
    data: { timeSpent?: number; description?: string; date?: Date },
  ): Promise<void> {
