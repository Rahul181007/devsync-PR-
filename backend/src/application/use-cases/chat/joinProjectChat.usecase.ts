...
import { IJoinProjectChatUseCase } from "../../interface/chat/IJoinProjectChatUseCase";

export class JoinProjectChatUseCase implements IJoinProjectChatUseCase{
    constructor(
    ...
    async execute(userId: string, companyId: string, projectId: string): Promise<void> {
