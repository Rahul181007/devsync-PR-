                                            ...
                                            {company.status === 'PENDING' && (
                                                <>
                                                    <button
                                                        ...
                                                        className="inline-flex items-center px-3 py-2 rounded-md text-white bg-green-600 hover:bg-green-700"
                                                    >
                                                        Approve
                                                    </button>
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex items-center px-3 py-2 rounded-md text-white bg-red-600 hover:bg-red-700"
                                                    >
                                                        Reject
                                                    </button>
                                                </>
